...
fn gen_rust_to_c_bindings(crate_dir: &Path, out_file: &str) {
    let mut config = cbindgen::Config {
        ...
        sys_includes: vec!["sys/types.h".into(), "sys/stat.h".into()],
...
fn gen_c_to_rust_bindings(crate_dir: &Path, in_file: &str, out_file: &str) {
    ...
    let allow_types = ["stat", "size_t", "ssize_t", "off_t", "mode_t", "O_*"];
    let allow_vars = ["O_.*"];
...
fn main() {
    ...
    gen_c_to_rust_bindings(&crate_dir, "ctypes.h", "ctypes_gen.rs");
