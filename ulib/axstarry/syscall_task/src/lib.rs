...
pub fn task_syscall(syscall_id: task_syscall_id::TaskSyscallId, args: [usize; 6]) -> SyscallResult {
    match syscall_id {
        ...
        SET_TID_ADDRESS => syscall_set_tid_address(args[0]),
        ...
        CLOCK_GET_TIME => syscall_clock_get_time(args[0], args[1] as *mut TimeSecs),
        ...
        #[cfg(feature = "futex")]
        SET_ROBUST_LIST => syscall_set_robust_list(args[0], args[1]),
        #[cfg(feature = "futex")]
        GET_ROBUST_LIST => {
        ...
        GETTIMER => syscall_gettimer(args[0], args[1] as *mut ITimerVal),
        ...
        #[cfg(feature = "schedule")]
        SCHED_GETAFFINITY => syscall_sched_getaffinity(args[0], args[1], args[2] as *mut usize),
        #[cfg(feature = "schedule")]
        SCHED_SETSCHEDULER => {
            syscall_sched_setscheduler(args[0], args[1], args[2] as *const SchedParam)
        }
        #[cfg(feature = "schedule")]
        SCHED_GETSCHEDULER => syscall_sched_getscheduler(args[0]),
        CLOCK_GETRES => syscall_clock_getres(args[0], args[1] as *mut TimeSecs),
