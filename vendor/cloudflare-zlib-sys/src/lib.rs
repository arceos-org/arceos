...
//! Bindings based on [libz-sys](https://crates.rs/crates/libz-sys).
...
pub unsafe fn deflateInit2(
    ...
    deflateInit2_(
        ...
        mem_level,
        strategy,
        ZLIB_VERSION.as_ptr() as *const _,
...
proident, sunt in culpa qui officia deserunt mollit anim id est laborum.";
        ...
        assert_eq!(0, compress2(gzbuf.as_mut_ptr(), &mut len,
                     source.as_bytes().as_ptr(), source.as_bytes().len() as uLong,
                     Z_BEST_COMPRESSION));
        ...
        assert_eq!(0, uncompress(unbuf.as_mut_ptr(), &mut len,
                      gzbuf.as_ptr(),
                      gzbuf.len() as uLong));
