...
#[doc = r" Proxy"]
pub struct _BYP_ADD_PARW<'a> {
    w: &'a mut W,
}
impl<'a> _BYP_ADD_PARW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn byp_add_par(&self) -> BYP_ADD_PARR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 4;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 4 - Bypass address bit 29 in parity calculation"]
    #[inline]
    pub fn byp_add_par(&mut self) -> _BYP_ADD_PARW {
        _BYP_ADD_PARW { w: self }
    }
    #[doc = "Bit 8 - SRAM parity flag"]
    #[inline]
