...
#[doc = r" Proxy"]
pub struct _OPAMP1_ENW<'a> {
    w: &'a mut W,
}
impl<'a> _OPAMP1_ENW<'a> {
...
impl R {
    ...
    #[inline]
    pub fn opamp1_en(&self) -> OPAMP1_ENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
...
impl W {
    ...
    #[doc = "Bit 0 - OPAMP1 enable"]
    #[inline]
    pub fn opamp1_en(&mut self) -> _OPAMP1_ENW {
        _OPAMP1_ENW { w: self }
    }
    #[doc = "Bit 1 - FORCE_VP"]
    #[inline]
    ...
    #[doc = "Bits 12:13 - Calibration selection"]
    #[inline]
    pub fn calsel(&mut self) -> _CALSELW {
        _CALSELW { w: self }
    }
    #[doc = "Bits 14:17 - Gain in PGA mode"]
    #[inline]
